...
INSERT INTO MLSSTalks VALUES(4,'Проблемні питання моделювання нелінійних аспектів гемодинаміки','Проблемные вопросы моделирования нелинейных аспектов гемодинамики','Hydrodynamic limit of nonlinear kinetic equations','2011-04-15 16:00:00',1,208);
INSERT INTO MLSSTalks VALUES(5,'Нейронна модель Ходжкіна-Хакслі (Hodgkin-Huxley). Наслідки та застосування','Нейронная модель Ходжкина-Хаксли (Hodgkin-Huxley). Следствия и применения','Modelling problems of nonlinear aspects of hemodynamics','2011-04-29 16:00:00',1,208);
